    ...
    public partial class AppModels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    KnowledgeBaseArticleId = table.Column<long>(type: "INTEGER", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserId = table.Column<long>(type: "INTEGER", nullable: false),
                    EngineerId = table.Column<long>(type: "INTEGER", nullable: true),
                    Title = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_Users_EngineerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TagsTagId = table.Column<long>(type: "INTEGER", nullable: false),
                    TicketsId = table.Column<long>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagTicket", x => new { x.TagsTagId, x.TicketsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KnowledgeBaseArticles_UserId",
                table: "KnowledgeBaseArticles",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Tags_KnowledgeBaseArticleId",
                table: "Tags",
